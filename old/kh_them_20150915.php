          ...
          <form class="form-horizontal" id="f_luu_kh" role="form" action="kh_detail.php" method="post">
              ...
              <div class="row">
                <div class="col-xs-9 col-md-6">
                  ...
                  <!--
                    <div class="form-group">
                      <label class="control-label col-xs-2" for"diachi">Tên:</label>
                      <div class="col-xs-10"><input type="text" class="form-control" id="hoten" name="hoten" placeholder=""></div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-2" for"diachi">Số ĐT1:</label>
                      <div class="col-xs-10"><input type="text" class="form-control" id="sdt1" name="sdt1" placeholder=""></div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-2" for"diachi">Số ĐT2:</label>
                      <div class="col-xs-10"><input type="text" class="form-control" id="sdt2" name="sdt2" placeholder=""></div>
                    </div>
                  -->                                                            
                    <div class="form-group">
                    ...
                    <!--
                    <div class="form-group">
                      <label class="control-label col-xs-2" for="email">Ghi chú:</label>
                      <div class="col-xs-10"><input type="text" class="form-control" id="mota_kh" name="mota_kh" placeholder=""></div>
                    </div> 
                    -->                   
                  </div>
                </div>
              ...
              <div class="row" style="margin-left: 10px;">
                <div class="col-xs-3 col-md-2">
                  <div class="form-horizontal">
                    <div class="form-group">
                      <select id="sel_trangthai" class="form-control" style="margin-bottom: 7px;">
                        <option value="1">Tư vấn</option>
                        <option value="2">Đặt mua</option>
                        <option value="3">Đã mua</option>
                        <option value="4">Hủy</option>
                      </select>
                      <select id="sel_calltype" class="form-control">
                ...
                <div class="col-xs-15 col-md-10">
                  <textarea id="txt_call_detail" class="form-control" style="height: 75px;"></textarea>
                </div>
              </div>
