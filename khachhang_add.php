		  	...
		  	<div class="row">
		  		<div class="col-xs-12 col-md-8">
					...
					<div class="form-group">
					  <label class="col-xs-3 col-md-2 control-label" for="fullname">Tên KH</label>
					  <div class="col-xs-9 col-md-6 clearfix">
					...
					<div class="row">
					<div class="form-group">
					  <label class="col-xs-3 col-md-2 control-label" for="mobile">Số điện thoại</label> 
					...
					<div class="row">
					<div class="form-group">
					  <label class="col-md-2 control-label" for="full_address">Địa chỉ</label>  
					  <div class="col-md-6">
					...
					<div class="row">
					<div class="form-group">
					  <label class="col-md-2 control-label" for="note_full_address">Ghi chú đ.c</label>  
					  <div class="col-md-6">
